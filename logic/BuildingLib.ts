...
class BuildingLib {
    ...
    /**
     * Initializes the board components of the Race given as input
     * @param race 
     */
    ...
    /**
     * The number of gaiaformers player will have will depend 
     * on the gaia level on techboard
     * @param level 
     */
    // public gaiaformerTech(level: number) {
    ...
    /**
     * Changes the value of BigBuildings
     * @param value 
     */
