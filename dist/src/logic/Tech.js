...
var Tech = /** @class */ (function () {
     ...
     * @param fed
     */
    Tech.prototype.putFed = function (fed) {
        this.fed = fed;
    };
    /**
    ...
    Tech.prototype.update = function (player) {
        ...
        if (this.lane === 0) {
            ...
            if (this.level == 5)
                player.getSpecialFedration(this.fed);
        }
        //range
        if (this.lane === 1) {
            if (this.level === 1) {
        ...
        if (this.lane === 3) {
            ...
            if (this.level === 2) {
                b2 = new Benefit_1.Benefit(0 /* Now */, null, null, [new Benefit_1.Value(3, Benefit_1.Material.ExtraPower)]);
            }
            if (this.level === 3) {
                b2 = new Benefit_1.Benefit(0 /* Now */, null, null, [new Benefit_1.Value(1, Benefit_1.Material.GaiaFormer)]);
