...
var MapBoard = /** @class */ (function () {
    ...
    MapBoard.prototype.setup = function (playerNumber) {
        ...
        spaces0[2].setPlanetType(Planet_1.PlanetType.Transdim);
        spaces0[4].setPlanetType(Planet_1.PlanetType.Blue);
        spaces0[5].setPlanetType(Planet_1.PlanetType.White);
        ...
        spaces1[2].setPlanetType(Planet_1.PlanetType.Gaia);
        spaces1[3].setPlanetType(Planet_1.PlanetType.Yellow);
        spaces1[4].setPlanetType(Planet_1.PlanetType.Transdim);
        spaces1[5].setPlanetType(Planet_1.PlanetType.White);
        ...
        spaces2[3].setPlanetType(Planet_1.PlanetType.Gaia);
        spaces2[5].setPlanetType(Planet_1.PlanetType.White);
        spaces2[8].setPlanetType(Planet_1.PlanetType.Transdim);
        //
        //
        ...
        spaces3[3].setPlanetType(Planet_1.PlanetType.Transdim);
        spaces3[4].setPlanetType(Planet_1.PlanetType.Red);
        spaces3[5].setPlanetType(Planet_1.PlanetType.Yellow);
        spaces3[8].setPlanetType(Planet_1.PlanetType.Gaia);
        //
        // this.randomRotation(spaces3)
        //
        //
        var spaces4 = Space.spiral(centers[4], 2);
        spaces4[0].setPlanetType(Planet_1.PlanetType.Gaia);
        spaces4[2].setPlanetType(Planet_1.PlanetType.Red);
        //
        // this.randomRotation(spaces4)
        //
        var spaces5 = Space.spiral(centers[5], 2);
        spaces5[7].setPlanetType(Planet_1.PlanetType.Yellow);
        spaces5[3].setPlanetType(Planet_1.PlanetType.Red);
        spaces5[4].setPlanetType(Planet_1.PlanetType.Gaia);
        //
        // this.randomRotation(spaces5);
        //
        //
        var spaces6 = Space.spiral(centers[6], 2);
        spaces6[3].setPlanetType(Planet_1.PlanetType.Yellow);
        spaces6[4].setPlanetType(Planet_1.PlanetType.Transdim);
        //
        // this.randomRotation(spaces6);
        //
        //
        var spaces7 = Space.spiral(centers[7], 2);
        spaces7[3].setPlanetType(Planet_1.PlanetType.Yellow);
        spaces7[4].setPlanetType(Planet_1.PlanetType.Transdim);
        spaces7[0].setPlanetType(Planet_1.PlanetType.Blue);
        //
        // this.randomRotation(spaces7)
        //
        //
        var spaces8 = Space.spiral(centers[8], 2);
        spaces8[0].setPlanetType(Planet_1.PlanetType.Gaia);
        spaces8[2].setPlanetType(Planet_1.PlanetType.Red);
        spaces8[3].setPlanetType(Planet_1.PlanetType.Red);
        //
        // this.randomRotation(spaces8)
        //
        var spaces9 = Space.spiral(centers[9], 2);
        spaces9[3].setPlanetType(Planet_1.PlanetType.Yellow);
        spaces9[4].setPlanetType(Planet_1.PlanetType.Transdim);
        //
